 ...
 */
zz.net.WebSocketClient.prototype.sendMessage = function( type, target, dataset, serviceCommandSource ){

	var msgset = new zz.net.models.MessageDataset( );
	var msgrow = /** @type {zz.net.models.MessageDatarow} */ ( msgset.createLast( ) );

	msgrow.type = type;
	msgrow.source = serviceCommandSource? serviceCommandSource: this.path_;
 ...
 * @param {zz.models.Dataset} dataset
 */
zz.net.WebSocketClient.prototype.sendCommandMessage = function( command, dataset, serviceCommandSource ){

	this.sendMessage( zz.net.enums.MessageType.COMMAND, command, dataset, serviceCommandSource );
};
