...
/** @define {string} */
zz.net.URL = 'ws://localhost:7777';

/** @type {Array} */
zz.net.PROTOCOLS = undefined;
 ...
 */
zz.net.WebSocketClient = function( ){

	goog.base( this );

	var url = zz.net.URL;
	var opt_protocol = zz.net.PROTOCOLS;
...
goog.addSingletonGetter( zz.net.WebSocketClient );
